<script>
    ...
    const levels = [
        { title: 'Level 1: .map()', component: Level1}, 
        { title: 'Level 2: .filter()', component: Level2},
        { title: 'Level 3: .find()', component: Level3},
        { title: 'Level 4: .reduce()', component: Level4},
        { title: 'Level 5: .sort()', component: Level5},
    ];
